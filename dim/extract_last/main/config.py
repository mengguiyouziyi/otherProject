...
config_list = [
	...
	# # intro
	# # tyc.tyc_jichu_quan
	# {'sel_columns': 'comp_name, intro',
	#  'sel_table': 'jianjie_shunqi_all',
	#  'db': 'spider',
	#  'inser_table': 'comp_intro_shunqi',
	#  'inser_columns': '(comp_full_name, intro)'},
	#
	# {'sel_columns': 'comp_name, intro',
	#  'sel_table': 'jianjie_114_all',
	#  'db': 'spider',
	#  'inser_table': 'comp_intro_114',
	#  'inser_columns': '(comp_full_name, intro)'},
	#
	# {'sel_columns': 'comp_name, intro',
	#  'sel_table': 'jianjie_huangye88_all',
	#  'db': 'spider',
	#  'inser_table': 'comp_intro_huangye88',
	#  'inser_columns': '(comp_full_name, intro)'},
	#
	# {'sel_columns': 'comp_name, intro',
	#  'sel_table': 'jianjie_wuyou_all',
	#  'db': 'spider',
	#  'inser_table': 'comp_intro_wuyou',
	#  'inser_columns': '(comp_full_name, intro)'},
	# #
	# {'sel_columns': 'comp_name, intro',
	#  'sel_table': 'jianjie_zhizao_all',
	#  'db': 'spider',
	#  'inser_table': 'comp_intro_zhongguozhizao',
	#  'inser_columns': '(comp_full_name, intro)'},
	#
	# # spider.hw_app
	# {
	...
	#
	# # website
	# {'sel_columns': 'quan_cheng, w_eb',
	#  'sel_table': 'tyc_jichu_quan',
	#  'db': 'tianyancha',
	#  'inser_table': 'comp_web_tyc',
	#  'inser_columns': '(comp_full_name, web_url)'},
	#
	# # logo
	# {'sel_columns': 'quan_cheng, logo',
	#  'sel_table': 'tyc_jichu_quan',
	#  'db': 'tianyancha',
	#  'inser_table': 'comp_logo_tyc',
	#  'inser_columns': '(comp_full_name, logo_url)'},
	#
	# # registaddr
	# {'sel_columns': 'quan_cheng, zhuce_dizhi',
	#  'sel_table': 'tyc_jichu_quan',
	#  'db': 'tianyancha',
	#  'inser_table': 'comp_registaddr_tyc',
	#  'inser_columns': '(comp_full_name, regaddr)'},
	#
	# # office
	# {'sel_columns': 'quan_cheng, a_ddress',
	#  'sel_table': 'tyc_jichu_quan',
	#  'db': 'tianyancha',
	#  'inser_table': 'comp_officeaddr_tyc',
	#  'inser_columns': '(comp_full_name, offaddr)'},
	#
	# # contact
	# {'sel_columns': 'quan_cheng, p_hone, e_mail',
	#  'sel_table': 'tyc_jichu_quan',
	#  'db': 'tianyancha',
	#  'inser_table': 'comp_contactinfo_tyc',
	#  'inser_columns': '(comp_full_name, phone, email)'},
	#
	# # intro
	# {'sel_columns': 'quan_cheng, c_desc',
	#  'sel_table': 'tyc_jichu_quan',
	#  'db': 'tianyancha',
